      ...
      {variant === 'green' && (
        <div className="flex items-center w-full max-w-[200px] justify-between">
          ...
          <svg width="60" height="16" viewBox="0 0 60 16" fill="none" xmlns="http://www.w3.org/2000/svg" className="mx-2 overflow-visible">
            <defs>
              <linearGradient id="miniPeacockEyeGrad" x1="0%" y1="100%" x2="100%" y2="0%">
                <stop offset="0%" stopColor="#1B4D3E" />
                <stop offset="50%" stopColor="#0B525B" />
                <stop offset="100%" stopColor="#0077B6" />
              </linearGradient>
              <linearGradient id="miniPeacockGoldGrad" x1="0%" y1="0%" x2="100%" y2="100%">
            ...
            <g transform="translate(24, 10) rotate(-35) translate(-3, -4)">
              <path d="M3,8 C1.2,5.3 1.2,2.7 3,0.7 C4.8,2.7 4.8,5.3 3,8 Z" fill="url(#miniPeacockEyeGrad)" stroke="url(#miniPeacockGoldGrad)" strokeWidth="0.6" />
            </g>
            ...
            <g transform="translate(30, 7) translate(-3.5, -5)">
              <path d="M3.5,10 C1.4,6.7 1.4,3.3 3.5,0.7 C5.6,3.3 5.6,6.7 3.5,10 Z" fill="url(#miniPeacockEyeGrad)" stroke="url(#miniPeacockGoldGrad)" strokeWidth="0.8" />
            </g>
          </svg>
          <div className="h-[1px] bg-primary-300/60 flex-1" />
        </div>
